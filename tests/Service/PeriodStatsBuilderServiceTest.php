 ...
 *
 * @group periodStatsBuilder
 */
class PeriodStatsBuilderServiceTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Service\PeriodStatsBuilderService
     */
    protected $s;
    /**
    ...
    public function setUp()
    {
        ...
        $this->s               = new Service\PeriodStatsBuilderService($this->callableService);
    }
    /**
     * @group unit
     */
