...
use Itq\Common\Traits\ServiceAware\ModelServiceAwareTrait;
 ...
 */
class ModelServiceAwareTraitTest extends AbstractServiceAwareTraitTestCase
{
    /**
     * @return ModelServiceAwareTrait
     */
    public function t()
    {
