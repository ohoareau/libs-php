...
use Itq\Common\Traits\ServiceAware\ResponseServiceAwareTrait;
 ...
 * @group traits/service-aware/response
 */
class ResponseServiceAwareTraitTest extends AbstractServiceAwareTraitTestCase
{
    /**
