...
use Itq\Common\Service\Model\ModelUpdateEnricherService;
 ...
 * @group services/model/update-enricher
 */
class ModelUpdateEnricherServiceTest extends AbstractServiceTestCase
{
    /**
     * @return ModelUpdateEnricherService
     */
    public function s()
    {
    ...
    {
        return [
            ['updateEnricher', Plugin\ModelUpdateEnricherInterface::class, ['supports', 'enrich'], 'getModelUpdateEnrichers', 'addModelUpdateEnricher', 'thetype', 'getModelUpdateEnricher'],
        ];
    }
}
