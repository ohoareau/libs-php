...
use Itq\Common\Service\Model\ModelFieldListFilterService;
 ...
 * @group services/model/field-list-filter
 */
class ModelFieldListFilterServiceTest extends AbstractServiceTestCase
{
    /**
     * @return ModelFieldListFilterService
     */
    public function s()
    {
    ...
    {
        return [
            ['fieldListFilter', Plugin\ModelFieldListFilterInterface::class, ['filter'], 'getModelFieldListFilters', 'addModelFieldListFilter'],
        ];
    }
}
