...
use Itq\Common\Plugin\TagProcessor\FormatterTagProcessor;
 ...
 * @group plugins/processors/tags/formatter
 */
class FormatterTagProcessorTest extends AbstractTagProcessorTestCase
{
    /**
     * @return FormatterTagProcessor
     */
    public function p()
    {
