...
use Itq\Common\Plugin\TagProcessor\ConverterTagProcessor;
 ...
 * @group plugins/processors/tags/converter
 */
class ConverterTagProcessorTest extends AbstractTagProcessorTestCase
{
    /**
     * @return ConverterTagProcessor
     */
    public function p()
    {
