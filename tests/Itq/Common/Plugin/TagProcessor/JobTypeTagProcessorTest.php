...
use Itq\Common\Plugin\TagProcessor\JobTypeTagProcessor;
 ...
 * @group plugins/processors/tags/job-type
 */
class JobTypeTagProcessorTest extends AbstractTagProcessorTestCase
{
    /**
     * @return JobTypeTagProcessor
     */
    public function p()
    {
