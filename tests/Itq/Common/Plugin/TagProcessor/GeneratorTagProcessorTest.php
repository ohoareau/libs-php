...
use Itq\Common\Plugin\TagProcessor\GeneratorTagProcessor;
 ...
 * @group plugins/processors/tags/generator
 */
class GeneratorTagProcessorTest extends AbstractTagProcessorTestCase
{
    /**
     * @return GeneratorTagProcessor
     */
    public function p()
    {
