...
use Itq\Common\Plugin\TagProcessor\TaskTagProcessor;
 ...
 * @group plugins/processors/tags/task
 */
class TaskTagProcessorTest extends AbstractTagProcessorTestCase
{
    /**
     * @return TaskTagProcessor
     */
    public function p()
    {
