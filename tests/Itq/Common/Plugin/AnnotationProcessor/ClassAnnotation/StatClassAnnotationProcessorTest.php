...
use Itq\Common\Plugin\AnnotationProcessor\ClassAnnotation\StatClassAnnotationProcessor;
 ...
 * @group plugins/annotation-processors/classes/stat
 */
class StatClassAnnotationProcessorTest extends AbstractClassAnnotationProcessorTestCase
{
    /**
     * @return StatClassAnnotationProcessor
     */
    public function p()
    {
