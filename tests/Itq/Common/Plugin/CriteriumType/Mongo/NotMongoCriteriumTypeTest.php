...
use Itq\Common\Plugin\CriteriumType\Mongo\NotMongoCriteriumType;
 ...
 * @group plugins/criterium-types/mongo/not
 */
class NotMongoCriteriumTypeTest extends AbstractMongoCriteriumTypeTestCase
{
    /**
     * @return NotMongoCriteriumType
     */
    public function c()
    {
