...
use Itq\Common\Plugin\CriteriumType\Mongo\ModMongoCriteriumType;
 ...
 * @group plugins/criterium-types/mongo/mod
 */
class ModMongoCriteriumTypeTest extends AbstractMongoCriteriumTypeTestCase
{
    /**
     * @return ModMongoCriteriumType
     */
    public function c()
    {
