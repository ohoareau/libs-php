...
use Itq\Common\Plugin\CriteriumType\Mongo\AllMongoCriteriumType;
 ...
 * @group plugins/criterium-types/mongo/all
 */
class AllMongoCriteriumTypeTest extends AbstractMongoCriteriumTypeTestCase
{
    /**
     * @return AllMongoCriteriumType
     */
    public function c()
    {
