...
use Itq\Common\Plugin\CriteriumType\Mongo\InMongoCriteriumType;
 ...
 * @group plugins/criterium-types/mongo/in
 */
class InMongoCriteriumTypeTest extends AbstractMongoCriteriumTypeTestCase
{
    /**
     * @return InMongoCriteriumType
     */
    public function c()
    {
