...
use Itq\Common\Plugin\PreprocessorStep\TagsPreprocessorStep;
 ...
 * @group plugins/preprocessor-steps/tags
 */
class TagsPreprocessorStepTest extends AbstractPreprocessorStepTestCase
{
    /**
     * @return TagsPreprocessorStep
     */
    public function s()
    {
