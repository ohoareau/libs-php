 ...
 */
class VirtualEmbeddedReferenceListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\VirtualEmbeddedReferenceList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyVirtualEmbeddedReferenceList($ctx->class, $ctx->property, $params);
    }
}
