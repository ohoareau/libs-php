 ...
 */
class CachedListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\CachedList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyCachedList($ctx->class, $ctx->property, $params);
    }
}
