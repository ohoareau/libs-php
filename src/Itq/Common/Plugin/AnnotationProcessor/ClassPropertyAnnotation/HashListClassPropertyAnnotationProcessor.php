 ...
 */
class HashListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\HashList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyHashList($ctx->class, $ctx->property, $params);
    }
}
