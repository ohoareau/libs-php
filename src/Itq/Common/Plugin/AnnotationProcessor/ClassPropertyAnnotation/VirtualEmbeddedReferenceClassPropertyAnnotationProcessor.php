 ...
 */
class VirtualEmbeddedReferenceClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\VirtualEmbeddedReference::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyVirtualEmbeddedReference($ctx->class, $ctx->property, $params);
    }
}
