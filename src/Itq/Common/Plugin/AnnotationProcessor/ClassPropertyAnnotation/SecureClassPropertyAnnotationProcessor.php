 ...
 */
class SecureClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Secure::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertySecure($ctx->class, $ctx->property, $params);
    }
}
