 ...
 */
class RefreshClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Refresh::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyRefresh($ctx->class, $ctx->property, $params);
    }
}
