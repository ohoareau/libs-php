 ...
 */
class DefaultValueClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\DefaultValue::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyDefaultValue($ctx->class, $ctx->property, $params);
    }
}
