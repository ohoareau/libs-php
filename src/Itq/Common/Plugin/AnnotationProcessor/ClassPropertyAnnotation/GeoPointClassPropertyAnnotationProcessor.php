 ...
 */
class GeoPointClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\GeoPoint::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyGeoPoint($ctx->class, $ctx->property, $params);
    }
}
