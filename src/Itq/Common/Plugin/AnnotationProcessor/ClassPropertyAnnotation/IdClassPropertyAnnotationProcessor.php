 ...
 */
class IdClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        $ctx->addModelPropertyId($ctx->class, $ctx->property, $params);
    }
}
