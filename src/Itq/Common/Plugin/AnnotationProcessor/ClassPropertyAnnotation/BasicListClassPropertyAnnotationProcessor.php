 ...
 */
class BasicListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\BasicList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyBasicList($ctx->class, $ctx->property, $params);
    }
}
