 ...
 */
class StorageClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Storage::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyStorage($ctx->class, $ctx->property, $params);
    }
}
