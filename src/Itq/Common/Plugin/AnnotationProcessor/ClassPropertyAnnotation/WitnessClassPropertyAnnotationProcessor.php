 ...
 */
class WitnessClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Witness::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyWitness($ctx->class, $ctx->property, $params);
    }
}
