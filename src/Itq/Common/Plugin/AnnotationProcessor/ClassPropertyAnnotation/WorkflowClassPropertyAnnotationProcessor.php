 ...
 */
class WorkflowClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Workflow::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyWorkflow($ctx->class, $ctx->property, $params);

        $container->getDefinition('app.workflow')->addMethodCall('registerFromDefinition', [$params['id'], $params]);
    }
}
