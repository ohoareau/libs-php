 ...
 */
class EmbeddedListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\EmbeddedList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyEmbeddedList($ctx->class, $ctx->property, $params);
    }
}
