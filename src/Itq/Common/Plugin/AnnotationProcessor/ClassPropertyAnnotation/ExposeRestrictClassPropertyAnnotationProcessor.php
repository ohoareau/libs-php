 ...
 */
class ExposeRestrictClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\ExposeRestrict::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyExposeRestrict($ctx->class, $ctx->property, $params);
    }
}
