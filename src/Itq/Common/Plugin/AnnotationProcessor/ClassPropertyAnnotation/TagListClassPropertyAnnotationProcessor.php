 ...
 */
class TagListClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\TagList::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyTagList($ctx->class, $ctx->property, $params);
    }
}
