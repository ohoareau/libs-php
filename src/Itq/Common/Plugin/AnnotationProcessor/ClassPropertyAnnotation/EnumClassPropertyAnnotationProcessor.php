 ...
 */
class EnumClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        $ctx->addModelPropertyEnum($ctx->class, $ctx->property, $params);
    }
}
