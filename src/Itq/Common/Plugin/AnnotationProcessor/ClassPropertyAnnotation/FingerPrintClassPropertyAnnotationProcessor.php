 ...
 */
class FingerPrintClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\FingerPrint::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyFingerPrint($ctx->class, $ctx->property, $params);
    }
}
