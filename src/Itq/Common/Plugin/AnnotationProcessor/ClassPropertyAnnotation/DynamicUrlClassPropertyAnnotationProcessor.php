 ...
 */
class DynamicUrlClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\DynamicUrl::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyDynamicUrl($ctx->class, $ctx->property, $params);
    }
}
