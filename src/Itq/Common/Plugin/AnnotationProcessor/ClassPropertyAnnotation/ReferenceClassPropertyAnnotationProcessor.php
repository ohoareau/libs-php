 ...
 */
class ReferenceClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Reference::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyReference($ctx->class, $ctx->property, $params);
    }
}
