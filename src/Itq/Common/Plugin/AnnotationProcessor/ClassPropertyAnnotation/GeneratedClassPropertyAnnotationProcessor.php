 ...
 */
class GeneratedClassPropertyAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Generated::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelPropertyGenerated($ctx->class, $ctx->property, $params);
    }
}
