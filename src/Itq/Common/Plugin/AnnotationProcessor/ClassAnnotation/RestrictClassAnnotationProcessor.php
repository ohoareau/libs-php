...
namespace Itq\Common\Plugin\AnnotationProcessor\ClassAnnotation;
 ...
 */
class RestrictClassAnnotationProcessor extends AbstractAnnotationProcessor
{
    /**
     * @return string
     */
    ...
    {
        return Annotation\Restrict::class;
    }
    /**
     * @param array               $params
    ...
    {
        $ctx->addModelRestrict($ctx->class, $params);
    }
}
