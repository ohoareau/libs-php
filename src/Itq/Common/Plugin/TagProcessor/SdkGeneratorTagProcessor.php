 ...
 */
class SdkGeneratorTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    public function process($tag, array $params, $id, Definition $d, ContainerBuilder $container, $ctx)
    {
        ...
        $this->addCall($container, 'app.sdk', 'addGenerator', [$params['target'], new Reference($id)]);
    }
}
