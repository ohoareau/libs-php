 ...
 */
class ModelRefresherTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    {
        $this->registerServicePlugin($tag, $id, $params, '#itq.aware.modelrefresher', 'modelRefresher', $ctx);
    }
}
