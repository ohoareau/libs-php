 ...
 */
class ModelCleanerTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    {
        $this->registerServicePlugin($tag, $id, $params, '#itq.aware.modelcleaner', 'modelCleaner', $ctx);
    }
}
