 ...
 */
class ModelRestricterTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    {
        $this->registerServicePlugin($tag, $id, $params, '#itq.aware.modelrestricter', 'modelRestricter', $ctx);
    }
}
