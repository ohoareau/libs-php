 ...
 */
class DocGeneratorTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    public function process($tag, array $params, $id, Definition $d, ContainerBuilder $container, $ctx)
    {
        ...
        $this->addCall($container, 'app.doc', 'addGenerator', [$params['type'], new Reference($id)]);
    }
}
