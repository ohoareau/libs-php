 ...
 */
class ModelDescriptorTagProcessor extends Base\AbstractTagProcessor
{
    /**
     * @return string
     */
    ...
    {
        $this->registerNamedServicePlugin($tag, $id, $params, 'app.metadata', 'modelDescriptor', $ctx);
    }
}
